...
import { Image, Title, Text, TextBGColor, TextImportancia, TextBackground, ParagrafoDoTextBackground, DivTextCreater} from "./style";
  ...
  return (
    <>
      ...
      <div className="container pb-5 pt-5 text-center">
        ...
        <p>
        A criação de sites profissionais oferece vantagens como credibilidade, controle sobre o conteúdo, melhor visibilidade nos mecanismos de 
        busca e integração com outras plataformas. Isso contribui para transmitir profissionalismo, alcançar um público mais amplo, aumentar a 
        confiança dos clientes, facilitar a interação e impulsionar o crescimento do negócio online.
      ...
      <TextBGColor className="img-fluid">      
